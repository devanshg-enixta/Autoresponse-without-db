...
def aspect_finder(review_file):
    ...
    for row in review_file.to_dict('records'):
        ...
        if row['reviewer_name'] == 'Pedigree Expert'or row['reviewer_name'] == 'PedigreeIndia':
            flag = 5
            rcs=0
        row['aspect']=aspect
...
def replier(x):
    ...
    if conf_score < 0:
        ...
        if "customer name" in reply:
            ...
            reply = x +', '+reply + " Please feel free to reach us on our toll free number 1800-4071-12121 or write to us at "+email+" for any further assistance. Regards Team "+brand+"."
    if flag == 1:
        reply = "Dear "+reviewer_name+", for any queries and facts regarding your "+pet+" please refer to the FAQs on our officil site "+faq+". Please feel free to reach us on our toll free number 1800-4071-12121 or write to us at "+email+" for any further assistance. Regards Team "+brand+"."
    if flag == 5:
        reply = ""
    ...
    if not row['aspect'] and not row['aspect_sentiment'] and flag == 0:
        reply = "Dear "+reviewer_name+",Thanks, we appreciate your feedback. "
    if 'confused' in row['review_text'] or 'confuse' in row['review_text']:
        reply = "Dear "+reviewer_name+", for any queries and facts regarding your "+pet+" please refer to the FAQs on our officil site "+faq+". Please feel free to reach us on our toll free number 1800-4071-12121 or write to us at "+email+" for any further assistance. Regards Team "+brand+"."
    if flag == 2:  
        reply = "Dear "+reviewer_name+", We are deeply saddened to hear about your "+pet+" . We request you to share your contact details so that we can assist you ASAP on our toll free number 1800-4071-12121 or write to us at "+email+". Regards Team "+brand+"."
    if pet == 'cat':
...
review_file = pd.read_csv(sys.argv[1],encoding='utf-8',quoting=csv.QUOTE_ALL)
